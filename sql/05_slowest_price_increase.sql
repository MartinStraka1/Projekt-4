...
FROM
    cenovy_vyvoj
WHERE
    cena_minuly_rok IS NOT NULL
    -- vynecháme první rok
    AND prumerna_cena > cena_minuly_rok
    -- pouze kategorie se zdražením
ORDER BY
    pct_zmena ASC
    -- od nejpomalejšího růstu
LIMIT 1;
-- jen ta jedna nejpomalejší
